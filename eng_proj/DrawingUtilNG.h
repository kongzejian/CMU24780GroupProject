...
namespace DrawingUtilNG {
	...
	void drawRectangle(double x, double y, double sizeX, double sizeY, bool filled,
		double outerSizeX = -1, double outerSizeY = -1);
	void drawTiltRect(double x, double y, double angle, double sizeX, double sizeY, bool filled);

	void drawIsoscelesTriangle(double x1, double y1,double x2, double y2, double height, bool filled);
